...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ksyun.live.demo.R.layout.activity_main);
        CrashReport.initCrashReport(getApplicationContext(), "900040861", true);

        setActionBarLayout(com.ksyun.live.demo.R.layout.media_actionbar,this);
    ...
    public void setActionBarLayout(int layoutId, Context mContext) {
        ...
        if (null != actionBar) {
            ...
            actionBar.setCustomView(com.ksyun.live.demo.R.layout.media_actionbar);


            media_net = (Button)findViewById(com.ksyun.live.demo.R.id.media_network);
            media_history = (Button)findViewById(com.ksyun.live.demo.R.id.media_history);
            media_setting = (Button)findViewById(com.ksyun.live.demo.R.id.media_setting);
    ...
    private void setDefaultFragment() {
        ...
        transaction.replace(com.ksyun.live.demo.R.id.contentFrame,localFragment);
        transaction.commit();
    }
    ...
    public void onClick(View view) {
        Intent intent;
        switch(view.getId()){
            case com.ksyun.live.demo.R.id.media_network:
                ...
                break;
            case com.ksyun.live.demo.R.id.media_history:
                Intent intent2 = new Intent(this,HistoryActivity.class);
                startActivity(intent2);
                Toast.makeText(MainActivity.this, "media_history", Toast.LENGTH_SHORT).show();
                break;
            case com.ksyun.live.demo.R.id.media_setting:
