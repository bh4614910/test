...
//            mVideoBitrate.setVisibility(View.VISIBLE);
            ...
            if(choosedebug.equals(Settings.DEBUGOFF)){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ksyun.live.demo.R.layout.qianyi_player);


        mPlayerPanel = (LinearLayout) findViewById(com.ksyun.live.demo.R.id.player_panel);
        mPlayerStartBtn = (ImageView) findViewById(com.ksyun.live.demo.R.id.player_start);
        mPlayerSeekbar = (SeekBar) findViewById(com.ksyun.live.demo.R.id.player_seekbar);
        mPlayerPosition = (TextView) findViewById(com.ksyun.live.demo.R.id.player_time);
        mLoadText = (TextView) findViewById(com.ksyun.live.demo.R.id.loading_text);
        mCpu = (TextView) findViewById(com.ksyun.live.demo.R.id.player_cpu);
        mMemInfo = (TextView) findViewById(com.ksyun.live.demo.R.id.player_mem);
        mVideoResolution = (TextView) findViewById(com.ksyun.live.demo.R.id.player_re);
        mVideoBitrate = (TextView) findViewById(com.ksyun.live.demo.R.id.player_br);
        mFrameRate = (TextView) findViewById(com.ksyun.live.demo.R.id.player_fr);
        mVideoBufferTime = (TextView) findViewById(com.ksyun.live.demo.R.id.player_video_time);
        mAudioBufferTime = (TextView) findViewById(com.ksyun.live.demo.R.id.player_audio_time);
        mServerIp = (TextView) findViewById(com.ksyun.live.demo.R.id.player_ip);
        mSdkVersion = (TextView) findViewById(com.ksyun.live.demo.R.id.player_sdk_version);
        mDNSTime = (TextView) findViewById(com.ksyun.live.demo.R.id.player_dns_time);
        mHttpConnectionTime = (TextView) findViewById(com.ksyun.live.demo.R.id.player_http_connection_time);

        toppanel = (RelativeLayout)findViewById(com.ksyun.live.demo.R.id.topPanel_player);
        reload = (Button)findViewById(com.ksyun.live.demo.R.id.player_reload);
        rotate = (Button)findViewById(com.ksyun.live.demo.R.id.btn_rotate_player);
        screen = (Button)findViewById(com.ksyun.live.demo.R.id.btn_screen_player);
        reload.setOnClickListener(this);
        rotate.setOnClickListener(this);
        screen.setOnClickListener(this);


        mPlayerScaleVideo = (Button) findViewById(com.ksyun.live.demo.R.id.player_scale);
        ...
        mVideoTextureView = (TextureView) findViewById(com.ksyun.live.demo.R.id.player_texture);
        ...
        mVideoSurfaceView = (SurfaceView) findViewById(com.ksyun.live.demo.R.id.player_surface);
            ...
            timerTask = new TimerTask() {
                ...
                public void run() {
                    try{
                        ...
                        message.what = VideoPlayerActivity.UPADTE_QOSVIEW;
                        if(message!=null){
    ...
    private View.OnClickListener mStartBtnListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            mHandler.sendMessageDelayed(msg,3000);
            if(mPause) {
                mPlayerStartBtn.setBackgroundResource(com.ksyun.live.demo.R.drawable.qyvideo_pause_btn);
                ksyMediaPlayer.pause();
                mPauseStartTime = System.currentTimeMillis();
            }else {
                mPlayerStartBtn.setBackgroundResource(com.ksyun.live.demo.R.drawable.qyvideo_start_btn);
                ksyMediaPlayer.start();
    ...
    public void onClick(View view) {
        ...
        mHandler.sendMessageDelayed(msg,3000);
        switch (view.getId()){
            case com.ksyun.live.demo.R.id.player_reload:
                String mVideoUrl1 = mDataSource;
                ...
                break;
            case com.ksyun.live.demo.R.id.btn_rotate_player:
                if (useHwCodec){
                    Toast.makeText(VideoPlayerActivity.this, "旋屏请设置软解", Toast.LENGTH_SHORT).show();
                }else{
                    ksyMediaPlayer.setRotateDegree((rotatenum+90)%360);
                    rotatenum += 90;
                }
                break;
            case com.ksyun.live.demo.R.id.btn_screen_player:
                if (useHwCodec){
                    Toast.makeText(VideoPlayerActivity.this, "截图请设置软解", Toast.LENGTH_SHORT).show();
                }else{
    ...
    public void savebitmap(Bitmap bitmap){
        File appDir = new File(Environment.getExternalStorageDirectory(),"com.ksyun.live.demo.demo");
        if (!appDir.exists()) {
            appDir.mkdir();
        }
